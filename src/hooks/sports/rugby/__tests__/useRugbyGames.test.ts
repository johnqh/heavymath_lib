...
import { useRugbyGames } from '../useRugbyGames';
...
describe('useRugbyGames', () => {
  ...
  it('should return games with favorited flag', () => {
    const { result } = renderHook(() => useRugbyGames(ic, wa), {
      wrapper: cw(),
    });
  ...
  it('should pass correct filters', () => {
    renderHook(() => useRugbyGames(ic, wa), { wrapper: cw() });
