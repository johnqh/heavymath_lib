...
describe('useRugbyLeagues', () => {
  ...
  it('should return leagues with favorited flag', () => {
    const { result } = renderHook(() => useRugbyLeagues(ic, wa), {
      wrapper: cw(),
    });
  ...
  it('should pass correct filters', () => {
    renderHook(() => useRugbyLeagues(ic, wa), { wrapper: cw() });
