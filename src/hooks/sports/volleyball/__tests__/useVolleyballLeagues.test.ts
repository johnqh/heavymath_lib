...
describe('useVolleyballLeagues', () => {
  ...
  it('should return leagues with favorited flag', () => {
    const { result } = renderHook(() => useVolleyballLeagues(ic, wa), {
      wrapper: cw(),
    });
  ...
  it('should pass correct filters', () => {
    renderHook(() => useVolleyballLeagues(ic, wa), { wrapper: cw() });
