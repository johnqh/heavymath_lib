...
import { useF1Teams } from '../useF1Teams';
...
import {
  useFavorites,
  useF1Teams as useApi,
} from '@sudobility/heavymath_indexer_client';
const mockUseApi = vi.mocked(useApi);
const mockUseFavorites = vi.mocked(useFavorites);
const mockData = [
  { id: 10, name: 'Red Bull Racing' },
  { id: 20, name: 'Mercedes' },
];
const mockFavs = [
  { id: 1, itemId: '10', category: 'sports', subcategory: 'f1', type: 'team' },
];
const ic = {} as any;
const wa = '0xabc';
const cw = () => {
...
describe('useF1Teams', () => {
  ...
  it('should return teams with favorited flag', () => {
    const { result } = renderHook(() => useF1Teams(ic, wa), { wrapper: cw() });
  ...
  it('should pass correct filters', () => {
    renderHook(() => useF1Teams(ic, wa), { wrapper: cw() });
